...
import { MatchPreviewComponent } from 'app/entities/match-preview/match-preview.component';
...
describe('Component Tests', () => {
  describe('MatchPreview Management Component', () => {
    let comp: MatchPreviewComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MatchPreviewComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.matchPreviews && comp.matchPreviews[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
